...
| P05 | Pagination, changes, tombstones, cursor recovery and reconnect | Fresh reads and content-bound continuation, Scalar reconciliation and Cadre messages pass. Company OS/Operate stream failures now recover through bounded polling with atomic changes/tombstones; independent retry/cancellation fixtures pass. Live journeys open |
...
| P09 | Actual framework provenance, offline version, disabled state and invocation | Actual 688-file Company OS 0.6.0 bundle verified; all retained resources are discoverable/readable in version-bound pages, required large catalog reconstructs exactly, complete design skill reaches the real chat loop. Settings/native visual gate remains open |
...
| P11 | Types, source builds and regression suite | Plugins303/303 and Work/Helm296/296 pass; 11 shared cases give588 distinct cases/49files. Full TypeScript and source bundles pass; GUI/native/runtime/provider gates remain open |
