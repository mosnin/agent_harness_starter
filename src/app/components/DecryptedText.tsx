...
/**
 * DecryptedText — React Bits (JavaScript + CSS variant), typed for this repo.
 * Scramble-then-reveal text animation. Used sparingly, on titles only: motion
 * with a purpose (arrival), never decoration on body copy.
 */
