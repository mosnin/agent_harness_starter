...
const USAGE = [
  ...
  "",
  "Skill evolution (STYX-gated; see docs/STYX_ARCHITECTURE.md):",
  "  synth <trajectory.json>   Synthesize a SKILL.md from a GATE-VERIFIED trajectory",
  "  refine <skill> <use.json> Fold verified use(s) back into an existing skill",
  "  track [skill] [flags]     Hash-chained Brier/Wilson outcome track record",
  "  track-batch <uses.json>   Record gated verdicts in bulk (idempotent, guarded)",
  "  trust [--policy-file <p>] Evaluate active/probation/demoted trust status",
  "  trust show                Read-only fail-closed effective-trust report",
  "  holdout <skill> [flags]   Paired holdout exit gate (accept/rollback/abstain)",
  "",
  "  help           Show this help",
  "",
