...
const USAGE = [
  ...
  "  verify --dir <path>  INDEPENDENT byte-level audit of a published live run dir:",
  "                       re-hash every manifest.json-listed file, catch extras,",
  "                       traversal-unsafe names, leftover *.tmp. Exit 0 iff all pass.",
  "  ready                Honest keyed-live readiness report for this environment",
  "                       (exit 0 iff a live-run-capable provider key is present).",
